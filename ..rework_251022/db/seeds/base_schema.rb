...
System::Country.upsert_all([
  { alpha2:"US", alpha3:"USA", numeric:"840", iso_short_name:"United States of America", dialing_prefix:"1", currency_primary_code:"USD", created_at:now, updated_at:now },
  { alpha2:"CA", alpha3:"CAN", numeric:"124", iso_short_name:"Canada", dialing_prefix:"1", currency_primary_code:"CAD", created_at:now, updated_at:now },
  { alpha2:"FR", alpha3:"FRA", numeric:"250", iso_short_name:"France", dialing_prefix:"33", currency_primary_code:"EUR", created_at:now, updated_at:now }
], unique_by: :alpha2)

# Regions
System::Region.upsert_all([
  { country_alpha2:"US", region_code:"PA", name:"Pennsylvania", kind:"state", iso_code:"US-PA", created_at:now, updated_at:now },
  { country_alpha2:"CA", region_code:"ON", name:"Ontario",      kind:"province", iso_code:"CA-ON", created_at:now, updated_at:now },
  { country_alpha2:"FR", region_code:"75", name:"Paris",        kind:"department", iso_code:"FR-75", created_at:now, updated_at:now }
], unique_by: %i[country_alpha2 region_code])

# Currencies
System::Currency.upsert_all([
  { code:"USD", numeric:"840", name:"US Dollar",       full_name:"United States dollar", minor_units:2, symbol:"$", unicode_codepoint:36,   created_at:now, updated_at:now },
  { code:"CAD", numeric:"124", name:"Canadian Dollar", full_name:"Canadian dollar",      minor_units:2, symbol:"$", unicode_codepoint:36,   created_at:now, updated_at:now },
  { code:"EUR", numeric:"978", name:"Euro",            full_name:"Euro",                 minor_units:2, symbol:"€", unicode_codepoint:8364, created_at:now, updated_at:now }
], unique_by: :code)

# Country↔Currency
System::CountryCurrency.upsert_all([
  { country_alpha2:"US", currency_code:"USD", is_primary:true,  legal_tender:true, created_at:now, updated_at:now },
  { country_alpha2:"CA", currency_code:"CAD", is_primary:true,  legal_tender:true, created_at:now, updated_at:now },
  { country_alpha2:"FR", currency_code:"EUR", is_primary:true,  legal_tender:true, created_at:now, updated_at:now }
...
Branch.upsert_all([
  {
    code:"001", name:"Main Office", status:"active", time_zone:"America/New_York",
  ...
  {
    code:"002", name:"East Side", status:"active", time_zone:"America/New_York",
